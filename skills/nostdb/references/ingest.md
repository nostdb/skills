...
3. Generate a deterministic provenance comment for every source location with `nostdb_provenance.py`; insert it immediately before the supported declaration. Use a stable page, section, heading, symbol, or line locator.
